...
def multi_thread_scan(dst_ips, max_threads, timeout, scan_type, interval, **extra):
    ...
    with ThreadPoolExecutor(max_threads) as executor:
        ...
        futures = _submit_dispatcher_executor(executor, dispatcher_job, dst_ips, dst_ports, **extra)
...
def _submit_dispatcher_executor(executor, dispatcher_job, dst_ips, dst_ports, **extra):
